 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cn(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function Jl(n){return(await fetch(n,{credentials:"include"})).ok}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xf="FirebaseError";class ct extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=xf,Object.setPrototypeOf(this,ct.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Ir.prototype.create)}}class Ir{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?Uf(o,r):"Error",l=`${this.serviceName}: ${a} (${s}).`;return new ct(s,l,r)}}function Uf(n,e){return n.replace(Ff,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Ff=/\{\$([^}]+)}/g;function Bf(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function nt(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(Ec(o)&&Ec(a)){if(!nt(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Ec(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var $;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})($||($={}));const Kf={debug:$.DEBUG,verbose:$.VERBOSE,info:$.INFO,warn:$.WARN,error:$.ERROR,silent:$.SILENT},Qf=$.INFO,Xf={[$.DEBUG]:"log",[$.VERBOSE]:"log",[$.INFO]:"info",[$.WARN]:"warn",[$.ERROR]:"error"},Yf=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Xf[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class po{constructor(e){this.name=e,this._logLevel=Qf,this._logHandler=Yf,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in $))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Kf[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,$.DEBUG,...e),this._logHandler(this,$.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,$.VERBOSE,...e),this._logHandler(this,$.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,$.INFO,...e),this._logHandler(this,$.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,$.WARN,...e),this._logHandler(this,$.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,$.ERROR,...e),this._logHandler(this,$.ERROR,...e)}}const Jf=(n,e)=>e.some(t=>n instanceof t);let vc,Tc;function Zf(){return vc||(vc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function em(){return Tc||(Tc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const eu=new WeakMap,Bi=new WeakMap,tu=new WeakMap,bi=new WeakMap,go=new WeakMap;function tm(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",o),n.removeEventListener("error",a)},o=()=>{t(vt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",o),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&eu.set(t,n)}).catch(()=>{}),go.set(e,n),e}function nm(n){if(Bi.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",a),n.removeEventListener("abort",a)},o=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",o),n.addEventListener("error",a),n.addEventListener("abort",a)});Bi.set(n,e)}let $i={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Bi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||tu.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return vt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function rm(n){$i=n($i)}function sm(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Pi(this),e,...t);return tu.set(r,e.sort?e.sort():[e]),vt(r)}:em().includes(n)?function(...e){return n.apply(Pi(this),e),vt(eu.get(this))}:function(...e){return vt(n.apply(Pi(this),e))}}function im(n){return typeof n=="function"?sm(n):(n instanceof IDBTransaction&&nm(n),Jf(n,Zf())?new Proxy(n,$i):n)}function vt(n){if(n instanceof IDBRequest)return tm(n);if(bi.has(n))return bi.get(n);const e=im(n);return e!==n&&(bi.set(n,e),go.set(e,n)),e}const Pi=n=>go.get(n);function om(n,e,{blocked:t,upgrade:r,blocking:s,terminated:o}={}){const a=indexedDB.open(n,e),l=vt(a);return r&&a.addEventListener("upgradeneeded",h=>{r(vt(a.result),h.oldVersion,h.newVersion,vt(a.transaction),h)}),t&&a.addEventListener("blocked",h=>t(h.oldVersion,h.newVersion,h)),l.then(h=>{o&&h.addEventListener("close",()=>o()),s&&h.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),l}const am=["get","getKey","getAll","getAllKeys","count"],cm=["put","add","delete","clear"],Ci=new Map;function Ic(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ci.get(e))return Ci.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=cm.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||am.includes(t)))return;const o=async function(a,...l){const h=this.transaction(a,s?"readwrite":"readonly");let d=h.store;return r&&(d=d.index(l.shift())),(await Promise.all([d[t](...l),s&&h.done]))[0]};return Ci.set(e,o),o}rm(n=>({...n,get:(e,t,r)=>Ic(e,t)||n.get(e,t,r),has:(e,t)=>!!Ic(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(um(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function um(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const qi="@firebase/app",wc="0.14.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ji="[DEFAULT]",Um={[qi]:"fire-core",[hm]:"fire-core-compat",[fm]:"fire-analytics",[dm]:"fire-analytics-compat",[pm]:"fire-app-check",[mm]:"fire-app-check-compat",[gm]:"fire-auth",[_m]:"fire-auth-compat",[ym]:"fire-rtdb",[Em]:"fire-data-connect",[vm]:"fire-rtdb-compat",[Tm]:"fire-fn",[Im]:"fire-fn-compat",[wm]:"fire-iid",[Am]:"fire-iid-compat",[Rm]:"fire-fcm",[Sm]:"fire-fcm-compat",[bm]:"fire-perf",[Pm]:"fire-perf-compat",[Cm]:"fire-rc",[km]:"fire-rc-compat",[Vm]:"fire-gcs",[Nm]:"fire-gcs-compat",[Dm]:"fire-fst",[Om]:"fire-fst-compat",[Mm]:"fire-vertex","fire-js":"fire-js",[Lm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn=xm;function nu(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:ji,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw Tt.create("bad-app-name",{appName:String(s)});if(t||(t=Xl()),!t)throw Tt.create("no-options");const o=fs.get(s);if(o){if(nt(t,o.options)&&nt(r,o.config))return o;throw Tt.create("duplicate-app",{appName:s})}const a=new Wf(s);for(const h of zi.values())a.addComponent(h);const l=new $m(t,r,a);return fs.set(s,l),l}function ru(n=ji){const e=fs.get(n);if(!e&&n===ji&&Xl())return nu();if(!e)throw Tt.create("no-app",{appName:n});return e}function It(n,e,t){let r=Um[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),rt.warn(a.join(" "));return}yn(new Qt(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qm="firebase-heartbeat-database",jm=1,dr="firebase-heartbeat-store";let ki=null;function su(){return ki||(ki=om(qm,jm,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(dr)}catch(t){console.warn(t)}}}}).catch(n=>{throw Tt.create("idb-open",{originalErrorMessage:n.message})})),ki}async function zm(n){try{const t=(await su()).transaction(dr),r=await t.objectStore(dr).get(iu(n));return await t.done,r}catch(e){if(e instanceof ct)rt.warn(e.message);else{const t=Tt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});rt.warn(t.message)}}}async function Rc(n,e){try{const r=(await su()).transaction(dr,"readwrite");await r.objectStore(dr).put(e,iu(n)),await r.done}catch(t){if(t instanceof ct)rt.warn(t.message);else{const r=Tt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});rt.warn(r.message)}}}function iu(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ym(n){yn(new Qt("platform-logger",e=>new lm(e),"PRIVATE")),yn(new Qt("heartbeat",e=>new Wm(e),"PRIVATE")),It(qi,wc,n),It(qi,wc,"esm2020"),It("fire-js","")}Ym("");var Jm="firebase",Zm="12.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */It(Jm,Zm,"app");function ou(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const ep=ou,au=new Ir("auth","Firebase",ou());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ms=new po("@firebase/auth");function tp(n,...e){ms.logLevel<=$.WARN&&ms.warn(`Auth (${kn}): ${n}`,...e)}function ns(n,...e){ms.logLevel<=$.ERROR&&ms.error(`Auth (${kn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gi(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function rp(){return Pc()==="http:"||Pc()==="https:"}function Pc(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ar{constructor(e,t){this.shortDelay=e,this.longDelay=t,st(t>e,"Short delay should be less than long delay!"),this.isMobile=Pf()||Nf()}get(){return sp()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ap=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],cp=new Ar(3e4,6e4);function To(n,e){return n.tenantId&&!e.tenantId?{...e,tenantId:n.tenantId}:e}async function Vn(n,e,t,r,s={}){return lu(n,s,async()=>{let o={},a={};r&&(e==="GET"?a=r:o={body:JSON.stringify(r)});const l=wr({key:n.config.apiKey,...a}).slice(1),h=await n._getAdditionalHeaders();h["Content-Type"]="application/json",n.languageCode&&(h["X-Firebase-Locale"]=n.languageCode);const d={method:e,headers:h,...o};return kf()||(d.referrerPolicy="no-referrer"),n.emulatorConfig&&Cn(n.emulatorConfig.host)&&(d.credentials="include"),cu.fetch()(await uu(n,n.config.apiHost,t,l),d)})}async function lu(n,e,t){n._canInitEmulator=!1;const r={...op,...e};try{const s=new up(n),o=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const a=await o.json();if("needConfirmation"in a)throw Xr(n,"account-exists-with-different-credential",a);if(o.ok&&!("errorMessage"in a))return a;{const l=o.ok?a.errorMessage:a.error.message,[h,d]=l.split(" : ");if(h==="FEDERATED_USER_ID_ALREADY_LINKED")throw Xr(n,"credential-already-in-use",a);if(h==="EMAIL_EXISTS")throw Xr(n,"email-already-in-use",a);if(h==="USER_DISABLED")throw Xr(n,"user-disabled",a);const m=r[h]||h.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw yo(n,m,d);Xe(n,m)}}catch(s){if(s instanceof ct)throw s;Xe(n,"network-request-failed",{message:String(s)})}}async function lp(n,e,t,r,s={}){const o=await Vn(n,e,t,r,s);return"mfaPendingCredential"in o&&Xe(n,"multi-factor-auth-required",{_serverResponse:o}),o}async function uu(n,e,t,r){const s=`${e}${t}?${r}`,o=n,a=o.config.emulator?vo(n.config,s):`${n.config.apiScheme}://${s}`;return ap.includes(t)&&(await o._persistenceManagerAvailable,o._getPersistenceType()==="COOKIE")?o._getPersistence()._getFinalTarget(a).toString():a}class up{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(xe(this.auth,"network-request-failed")),cp.get())})}}function Xr(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=xe(n,e,r);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hp(n,e){return Vn(n,"POST","/v1/accounts:delete",e)}async function ps(n,e){return Vn(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function fr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof ct&&fp(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function fp({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gs(n){var y;const e=n.auth,t=await n.getIdToken(),r=await fr(n,ps(e,{idToken:t}));x(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=(y=s.providerUserInfo)!=null&&y.length?hu(s.providerUserInfo):[],a=gp(n.providerData,o),l=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=l?h:!1,m={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Hi(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,m)}async function pp(n){const e=_e(n);await gs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function gp(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function hu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _p(n,e){const t=await lu(n,{},async()=>{const r=wr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:o}=n.config,a=await uu(n,s,"/v1/token",`key=${o}`),l=await n._getAdditionalHeaders();l["Content-Type"]="application/x-www-form-urlencoded";const h={method:"POST",headers:l,body:r};return n.emulatorConfig&&Cn(n.emulatorConfig.host)&&(h.credentials="include"),cu.fetch()(a,h)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function yp(n,e){return Vn(n,"POST","/v2/accounts:revokeToken",To(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){x(e.idToken,"internal-error"),x(typeof e.idToken<"u","internal-error"),x(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):Cc(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){x(e.length!==0,"internal-error");const t=Cc(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(x(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:r,refreshToken:s,expiresIn:o}=await _p(e,t);this.updateTokensAndExpiration(r,s,Number(o))}updateTokensAndExpiration(e,t,r){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+r*1e3}static fromJSON(e,t){const{refreshToken:r,accessToken:s,expirationTime:o}=t,a=new dn;return r&&(x(typeof r=="string","internal-error",{appName:e}),a.refreshToken=r),s&&(x(typeof s=="string","internal-error",{appName:e}),a.accessToken=s),o&&(x(typeof o=="number","internal-error",{appName:e}),a.expirationTime=o),a}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new dn,this.toJSON())}_performRefresh(){return Ze("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pt(n,e){x(typeof n=="string"||typeof n>"u","internal-error",{appName:e})}class Le{constructor({uid:e,auth:t,stsTokenManager:r,...s}){this.providerId="firebase",this.proactiveRefresh=new mp(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=e,this.auth=t,this.stsTokenManager=r,this.accessToken=r.accessToken,this.displayName=s.displayName||null,this.email=s.email||null,this.emailVerified=s.emailVerified||!1,this.phoneNumber=s.phoneNumber||null,this.photoURL=s.photoURL||null,this.isAnonymous=s.isAnonymous||!1,this.tenantId=s.tenantId||null,this.providerData=s.providerData?[...s.providerData]:[],this.metadata=new Hi(s.createdAt||void 0,s.lastLoginAt||void 0)}async getIdToken(e){const t=await fr(this,this.stsTokenManager.getToken(this.auth,e));return x(t,this.auth,"internal-error"),this.accessToken!==t&&(this.accessToken=t,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),t}getIdTokenResult(e){return dp(this,e)}reload(){return pp(this)}_assign(e){this!==e&&(x(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(t=>({...t})),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const t=new Le({...this,auth:e,stsTokenManager:this.stsTokenManager._clone()});return t.metadata._copy(this.metadata),t}_onReload(e){x(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,t=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),t&&await gs(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(Oe(this.auth.app))return Promise.reject(Wt(this.auth));const e=await this.getIdToken();return await fr(this,hp(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return{uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>({...e})),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId,...this.metadata.toJSON(),apiKey:this.auth.config.apiKey,appName:this.auth.name}}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,t){const r=t.displayName??void 0,s=t.email??void 0,o=t.phoneNumber??void 0,a=t.photoURL??void 0,l=t.tenantId??void 0,h=t._redirectEventId??void 0,d=t.createdAt??void 0,m=t.lastLoginAt??void 0,{uid:y,emailVerified:T,isAnonymous:P,providerData:N,stsTokenManager:M}=t;x(y&&M,e,"internal-error");const k=dn.fromJSON(this.name,M);x(typeof y=="string",e,"internal-error"),pt(r,e.name),pt(s,e.name),x(typeof T=="boolean",e,"internal-error"),x(typeof P=="boolean",e,"internal-error"),pt(o,e.name),pt(a,e.name),pt(l,e.name),pt(h,e.name),pt(d,e.name),pt(m,e.name);const H=new Le({uid:y,auth:e,email:s,emailVerified:T,displayName:r,isAnonymous:P,photoURL:a,phoneNumber:o,tenantId:l,stsTokenManager:k,createdAt:d,lastLoginAt:m});return N&&Array.isArray(N)&&(H.providerData=N.map(z=>({...z}))),h&&(H._redirectEventId=h),H}static async _fromIdTokenResponse(e,t,r=!1){const s=new dn;s.updateFromServerResponse(t);const o=new Le({uid:t.localId,auth:e,stsTokenManager:s,isAnonymous:r});return await gs(o),o}static async _fromGetAccountInfoResponse(e,t,r){const s=t.users[0];x(s.localId!==void 0,"internal-error");const o=s.providerUserInfo!==void 0?hu(s.providerUserInfo):[],a=!(s.email&&s.passwordHash)&&!(o!=null&&o.length),l=new dn;l.updateFromIdToken(r);const h=new Le({uid:s.localId,auth:e,stsTokenManager:l,isAnonymous:a}),d={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:o,metadata:new Hi(s.createdAt,s.lastLoginAt),isAnonymous:!(s.email&&s.passwordHash)&&!(o!=null&&o.length)};return Object.assign(h,d),h}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tu(n,e=[]){let t;switch(n){case"Browser":t=Nc(we());break;case"Worker":t=`${Nc(we())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${kn}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ip(n,e={}){return Vn(n,"GET","/v2/passwordPolicy",To(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kp(n,e){const t=_o(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(nt(o,e??{}))return s;Xe(s,"already-initialized")}return t.initialize({options:e})}function Vp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(et);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Np(n,e,t){const r=Ns(n);x(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Iu(e),{host:a,port:l}=Dp(e),h=l===null?"":`:${l}`,d={url:`${o}//${a}${h}/`},m=Object.freeze({host:a,port:l,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){x(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),x(nt(d,r.config.emulator)&&nt(m,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=m,r.settings.appVerificationDisabledForTesting=!0,Cn(a)?(Jl(`${o}//${a}${h}`),Zl("Auth",!0)):Mp()}function Iu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Dp(n){const e=Iu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:Mc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:Mc(a)}}}function Mc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Mp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mn(n,e){return lp(n,"POST","/v1/accounts:signInWithIdp",To(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rr extends Ro{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _s extends ct{constructor(e,t,r,s){super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,_s.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new _s(e,t,r,s)}}function Au(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(o=>{throw o.code==="auth/multi-factor-auth-required"?_s._fromErrorAndOperation(n,o,e,r):o})}async function Lp(n,e,t=!1){const r=await fr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return En._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xp(n,e,t=!1){const{auth:r}=n;if(Oe(r.app))return Promise.reject(Wt(r));const s="reauthenticate";try{const o=await fr(n,Au(r,s,e,n),t);x(o.idToken,r,"internal-error");const a=Io(o.idToken);x(a,r,"internal-error");const{sub:l}=a;return x(n.uid===l,r,"user-mismatch"),En._forOperation(n,s,o)}catch(o){throw(o==null?void 0:o.code)==="auth/user-not-found"&&Xe(r,"user-mismatch"),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lg="pendingRedirect",ss=new Map;class ug extends Mu{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ss.get(this.auth._key());if(!e){try{const r=await hg(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ss.set(this.auth._key(),e)}return this.bypassAuthState||ss.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function hg(n,e){const t=mg(e),r=fg(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function dg(n,e){ss.set(n._key(),e)}function fg(n){return et(n._redirectPersistence)}function mg(n){return rs(lg,n.config.apiKey,n.name)}async function pg(n,e,t=!1){if(Oe(n.app))return Promise.reject(Wt(n));const r=Ns(n),s=Du(r,e),a=await new ug(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Eg(n,e={}){return Vn(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ag=new Ar(3e4,6e4);function Fc(){const n=ze().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Rg(n){return new Promise((e,t)=>{var s,o,a;function r(){Fc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Fc(),t(xe(n,"network-request-failed"))},timeout:Ag.get()})}if((o=(s=ze().gapi)==null?void 0:s.iframes)!=null&&o.Iframe)e(gapi.iframes.getContext());else if((a=ze().gapi)!=null&&a.load)r();else{const l=Cp("iframefcb");return ze()[l]=()=>{gapi.load?r():t(xe(n,"network-request-failed"))},bp(`${Pp()}?onload=${l}`).catch(h=>t(h))}}).catch(e=>{throw is=null,e})}let is=null;function Sg(n){return is=is||Rg(n),is}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bg=new Ar(5e3,15e3),Pg="__/auth/iframe",Cg="emulator/auth/iframe",kg={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Vg=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ng(n){const e=n.config;x(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?vo(e,Cg):`https://${n.config.authDomain}/${Pg}`,r={apiKey:e.apiKey,appName:n.name,v:kn},s=Vg.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${wr(r).slice(1)}`}async function Dg(n){const e=await Sg(n),t=ze().gapi;return x(t,n,"internal-error"),e.open({where:document.body,url:Ng(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:kg,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=xe(n,"network-request-failed"),l=ze().setTimeout(()=>{o(a)},bg.get());function h(){ze().clearTimeout(l),s(r)}r.ping(h).then(h,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $g="__/auth/handler",qg="emulator/auth/handler",jg=encodeURIComponent("fac");async function $c(n,e,t,r,s,o){x(n.config.authDomain,n,"auth-domain-config-required"),x(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:kn,eventId:s};if(e instanceof Ro){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Bf(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[m,y]of Object.entries({}))a[m]=y}if(e instanceof Rr){const m=e.getScopes().filter(y=>y!=="");m.length>0&&(a.scopes=m.join(","))}n.tenantId&&(a.tid=n.tenantId);const l=a;for(const m of Object.keys(l))l[m]===void 0&&delete l[m];const h=await n._getAppCheckToken(),d=h?`#${jg}=${encodeURIComponent(h)}`:"";return`${zg(n)}?${wr(l).slice(1)}${d}`}function zg({config:n}){return n.emulator?vo(n,qg):`https://${n.authDomain}/${$g}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni="webStorageSupport";class Gg{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Pu,this._completeRedirectFn=pg,this._overrideRedirectResult=dg}async _openPopup(e,t,r,s){var a;st((a=this.eventManagers[e._key()])==null?void 0:a.manager,"_initialize() not called before _openPopup()");const o=await $c(e,t,r,Gi(),s);return Fg(e,o,So())}async _openRedirect(e,t,r,s){await this._originValidation(e);const o=await $c(e,t,r,Gi(),s);return Kp(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:o}=this.eventManagers[t];return s?Promise.resolve(s):(st(o,"If manager is not set, promise should be"),o)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Dg(e),r=new _g(e);return t.register("authEvent",s=>(x(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ni,{type:Ni},s=>{var a;const o=(a=s==null?void 0:s[0])==null?void 0:a[Ni];o!==void 0&&t(!!o),Xe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Ig(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return vu()||mu()||wo()}}const Hg=Gg;var qc="@firebase/auth",jc="1.12.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yt=new po("@firebase/firestore");function an(){return Yt.logLevel}function D(n,...e){if(Yt.logLevel<=$.DEBUG){const t=e.map(Po);Yt.debug(`Firestore (${Nn}): ${n}`,...t)}}function it(n,...e){if(Yt.logLevel<=$.ERROR){const t=e.map(Po);Yt.error(`Firestore (${Nn}): ${n}`,...t)}}function vn(n,...e){if(Yt.logLevel<=$.WARN){const t=e.map(Po);Yt.warn(`Firestore (${Nn}): ${n}`,...t)}}function Po(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,qu(n,r,t)}function qu(n,e,t){let r=`FIRESTORE (${Nn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw it(r),new Error(r)}function W(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||qu(e,s,r)}function F(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oe(n,e){const t={typeString:n};return e&&(t.value=e),t}function br(n,e){if(!Gu(n))throw new V(S.INVALID_ARGUMENT,"JSON must be an object");let t;for(const r in e)if(e[r]){const s=e[r].typeString,o="value"in e[r]?{value:e[r].value}:void 0;if(!(r in n)){t=`JSON missing required field: '${r}'`;break}const a=n[r];if(s&&typeof a!==s){t=`JSON field '${r}' must be a ${s}.`;break}if(o!==void 0&&a!==o.value){t=`Expected '${r}' field to equal '${o.value}'`;break}}if(t)throw new V(S.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dn(n){if(n.code!==S.FAILED_PRECONDITION||n.message!==g_)throw n;D("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ko=-1;function xs(n){return n==null}function vs(n){return n===0&&1/n==-1/0}function E_(n){return typeof n=="number"&&Number.isInteger(n)&&!vs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qu="server_timestamp",Xu="__type__",Yu="__previous_value__",Ju="__local_write_time__";function Vo(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Xu])==null?void 0:r.stringValue)===Qu}function Us(n){const e=n.mapValue.fields[Yu];return Vo(e)?Us(e):e}function pr(n){const e=bt(n.mapValue.fields[Ju].timestampValue);return new J(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class w_{constructor(e,t,r,s,o,a,l,h,d,m){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=l,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=m}}const Ts="(default)";class gr{constructor(e,t){this.projectId=e,this.database=t||Ts}static empty(){return new gr("","")}get isDefaultDatabase(){return this.database===Ts}isEqual(e){return e instanceof gr&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ce{constructor(e){this.value=e}static empty(){return new Ce({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!cs(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=cr(t)}setAll(e){let t=pe.emptyPath(),r={},s=[];e.forEach((a,l)=>{if(!t.isImmediateParentOf(l)){const h=this.getFieldsMap(t);this.applyChanges(h,r,s),r={},s=[],t=l.popLast()}a?r[l.lastSegment()]=cr(a):s.push(l.lastSegment())});const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());cs(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ye(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];cs(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Dt(t,(s,o)=>e[s]=o);for(const s of r)delete e[s]}clone(){return new Ce(cr(this.value))}}function th(n){const e=[];return Dt(n.fields,(t,r)=>{const s=new pe([t]);if(cs(r)){const o=th(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)}),new Ne(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yr{constructor(e,t="asc"){this.field=e,this.dir=t}}function b_(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vs(e)?"-0":e}}function mh(n){return{integerValue:""+n}}function ph(n,e){return E_(e)?mh(e):Lo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $s{constructor(){this._=void 0}}function H_(n,e,t){return n instanceof Er?function(s,o){const a={fields:{[Xu]:{stringValue:Qu},[Ju]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return o&&Vo(o)&&(o=Us(o)),o&&(a.fields[Yu]=o),{mapValue:a}}(t,e):n instanceof An?_h(n,e):n instanceof Rn?yh(n,e):function(s,o){const a=gh(s,o),l=dl(a)+dl(s.Ae);return Yi(a)&&Yi(s.Ae)?mh(l):Lo(s.serializer,l)}(n,e)}function W_(n,e,t){return n instanceof An?_h(n,e):n instanceof Rn?yh(n,e):t}function gh(n,e){return n instanceof vr?function(r){return Yi(r)||function(o){return!!o&&"doubleValue"in o}(r)}(e)?e:{integerValue:0}:null}class Er extends $s{}class An extends $s{constructor(e){super(),this.elements=e}}function _h(n,e){const t=Eh(e);for(const r of n.elements)t.some(s=>Ye(s,r))||t.push(r);return{arrayValue:{values:t}}}class Rn extends $s{constructor(e){super(),this.elements=e}}function yh(n,e){let t=Eh(e);for(const r of n.elements)t=t.filter(s=>!Ye(s,r));return{arrayValue:{values:t}}}class vr extends $s{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function dl(n){return te(n.integerValue||n.doubleValue)}function Eh(n){return No(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qs{constructor(e,t){this.field=e,this.transform=t}}function K_(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof An&&s instanceof An||r instanceof Rn&&s instanceof Rn?Tn(r.elements,s.elements,Ye):r instanceof vr&&s instanceof vr?Ye(r.Ae,s.Ae):r instanceof Er&&s instanceof Er}(n.transform,e.transform)}class Q_{constructor(e,t){this.version=e,this.transformResults=t}}class He{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new He}static exists(e){return new He(void 0,e)}static updateTime(e){return new He(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ls(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class js{}function vh(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Ih(n.key,He.none()):new Pr(n.key,n.data,He.none());{const t=n.data,r=Ce.empty();let s=new le(pe.comparator);for(let o of e.fields)if(!s.has(o)){let a=t.field(o);a===null&&o.length>1&&(o=o.popLast(),a=t.field(o)),a===null?r.delete(o):r.set(o,a),s=s.add(o)}return new Mt(n.key,r,new Ne(s.toArray()),He.none())}}function X_(n,e,t){n instanceof Pr?function(s,o,a){const l=s.value.clone(),h=ml(s.fieldTransforms,o,a.transformResults);l.setAll(h),o.convertToFoundDocument(a.version,l).setHasCommittedMutations()}(n,e,t):n instanceof Mt?function(s,o,a){if(!ls(s.precondition,o))return void o.convertToUnknownDocument(a.version);const l=ml(s.fieldTransforms,o,a.transformResults),h=o.data;h.setAll(Th(s)),h.setAll(l),o.convertToFoundDocument(a.version,h).setHasCommittedMutations()}(n,e,t):function(s,o,a){o.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function hr(n,e,t,r){return n instanceof Pr?function(o,a,l,h){if(!ls(o.precondition,a))return l;const d=o.value.clone(),m=pl(o.fieldTransforms,h,a);return d.setAll(m),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Mt?function(o,a,l,h){if(!ls(o.precondition,a))return l;const d=pl(o.fieldTransforms,h,a),m=a.data;return m.setAll(Th(o)),m.setAll(d),a.convertToFoundDocument(a.version,m).setHasLocalMutations(),l===null?null:l.unionWith(o.fieldMask.fields).unionWith(o.fieldTransforms.map(y=>y.field))}(n,e,t,r):function(o,a,l){return ls(o.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):l}(n,e,t)}function Y_(n,e){let t=null;for(const r of n.fieldTransforms){const s=e.data.field(r.field),o=gh(r.transform,s||null);o!=null&&(t===null&&(t=Ce.empty()),t.set(r.field,o))}return t||null}function fl(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Tn(r,s,(o,a)=>K_(o,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Pr extends js{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Mt extends js{constructor(e,t,r,s,o=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=o,this.type=1}getFieldMask(){return this.fieldMask}}function Th(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function ml(n,e,t){const r=new Map;W(n.length===t.length,32656,{Re:t.length,Ve:n.length});for(let s=0;s<t.length;s++){const o=n[s],a=o.transform,l=e.data.field(o.field);r.set(o.field,W_(a,l,t[s]))}return r}function pl(n,e,t){const r=new Map;for(const s of n){const o=s.transform,a=t.data.field(s.field);r.set(s.field,H_(o,a,e))}return r}class Ih extends js{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class J_ extends js{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class us{constructor(e,t,r,s){this.be=e,this.removedTargetIds=t,this.key=r,this.De=s}}class Ah{constructor(e,t){this.targetId=e,this.Ce=t}}class Rh{constructor(e,t,r=ye.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class yl{constructor(){this.ve=0,this.Fe=El(),this.Me=ye.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return this.ve!==0}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=j(),t=j(),r=j();return this.Fe.forEach((s,o)=>{switch(o){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:L(38017,{changeType:o})}}),new Cr(this.Me,this.xe,e,t,r)}qe(){this.Oe=!1,this.Fe=El()}Qe(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}$e(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}Ue(){this.ve+=1}Ke(){this.ve-=1,W(this.ve>=0,3241,{ve:this.ve})}We(){this.Oe=!0,this.xe=!0}}class iy{constructor(e){this.Ge=e,this.ze=new Map,this.je=at(),this.Je=es(),this.He=es(),this.Ye=new Z(q)}Ze(e){for(const t of e.be)e.De&&e.De.isFoundDocument()?this.Xe(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,t=>{const r=this.nt(t);switch(e.state){case 0:this.rt(t)&&r.Le(e.resumeToken);break;case 1:r.Ke(),r.Ne||r.qe(),r.Le(e.resumeToken);break;case 2:r.Ke(),r.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(r.We(),r.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),r.Le(e.resumeToken));break;default:L(56790,{state:e.state})}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach((r,s)=>{this.rt(s)&&t(s)})}st(e){const t=e.targetId,r=e.Ce.count,s=this.ot(t);if(s){const o=s.target;if(Zi(o))if(r===0){const a=new O(o.path);this.et(t,a,Ie.newNoDocument(a,U.min()))}else W(r===1,20013,{expectedCount:r});else{const a=this._t(t);if(a!==r){const l=this.ut(e),h=l?this.ct(l,e,a):1;if(h!==0){this.it(t);const d=h===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ye=this.Ye.insert(t,d)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:o=0}=t;let a,l;try{a=Pt(r).toUint8Array()}catch(h){if(h instanceof Ku)return vn("Decoding the base64 bloom filter in existence filter failed ("+h.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw h}try{l=new Uo(a,s,o)}catch(h){return vn(h instanceof nr?"BloomFilter error: ":"Applying bloom filter failed: ",h),null}return l.ge===0?null:l}ct(e,t,r){return t.Ce.count===r-this.Pt(e,t.targetId)?0:2}Pt(e,t){const r=this.Ge.getRemoteKeysForTarget(t);let s=0;return r.forEach(o=>{const a=this.Ge.ht(),l=`projects/${a.projectId}/databases/${a.database}/documents/${o.path.canonicalString()}`;e.mightContain(l)||(this.et(t,o,null),s++)}),s}Tt(e){const t=new Map;this.ze.forEach((o,a)=>{const l=this.ot(a);if(l){if(o.current&&Zi(l.target)){const h=new O(l.target.path);this.It(h).has(a)||this.Et(a,h)||this.et(a,h,Ie.newNoDocument(h,e))}o.Be&&(t.set(a,o.ke()),o.qe())}});let r=j();this.He.forEach((o,a)=>{let l=!0;a.forEachWhile(h=>{const d=this.ot(h);return!d||d.purpose==="TargetPurposeLimboResolution"||(l=!1,!1)}),l&&(r=r.add(o))}),this.je.forEach((o,a)=>a.setReadTime(e));const s=new zs(e,t,this.Ye,this.je,r);return this.je=at(),this.Je=es(),this.He=es(),this.Ye=new Z(q),s}Xe(e,t){if(!this.rt(e))return;const r=this.Et(e,t.key)?2:0;this.nt(e).Qe(t.key,r),this.je=this.je.insert(t.key,t),this.Je=this.Je.insert(t.key,this.It(t.key).add(e)),this.He=this.He.insert(t.key,this.dt(t.key).add(e))}et(e,t,r){if(!this.rt(e))return;const s=this.nt(e);this.Et(e,t)?s.Qe(t,1):s.$e(t),this.He=this.He.insert(t,this.dt(t).delete(e)),this.He=this.He.insert(t,this.dt(t).add(e)),r&&(this.je=this.je.insert(t,r))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}Ue(e){this.nt(e).Ue()}nt(e){let t=this.ze.get(e);return t||(t=new yl,this.ze.set(e,t)),t}dt(e){let t=this.He.get(e);return t||(t=new le(q),this.He=this.He.insert(e,t)),t}It(e){let t=this.Je.get(e);return t||(t=new le(q),this.Je=this.Je.insert(e,t)),t}rt(e){const t=this.ot(e)!==null;return t||D("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new yl),this.Ge.getRemoteKeysForTarget(e).forEach(t=>{this.et(e,t,null)})}Et(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function es(){return new Z(O.comparator)}function El(){return new Z(O.comparator)}const oy={asc:"ASCENDING",desc:"DESCENDING"},ay={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},cy={and:"AND",or:"OR"};class ly{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function to(n,e){return n.useProto3Json||xs(e)?e:{value:e}}function Rs(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Sh(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function uy(n,e){return Rs(n,e.toTimestamp())}function We(n){return W(!!n,49232),U.fromTimestamp(function(t){const r=bt(t);return new J(r.seconds,r.nanos)}(n))}function Fo(n,e){return no(n,e).canonicalString()}function no(n,e){const t=function(s){return new X(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function bh(n){const e=X.fromString(n);return W(Nh(e),10190,{key:e.toString()}),e}function ro(n,e){return Fo(n.databaseId,e.path)}function Mi(n,e){const t=bh(e);if(t.get(1)!==n.databaseId.projectId)throw new V(S.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new V(S.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new O(Ch(t))}function Ph(n,e){return Fo(n.databaseId,e)}function hy(n){const e=bh(n);return e.length===4?X.emptyPath():Ch(e)}function so(n){return new X(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Ch(n){return W(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function vl(n,e,t){return{name:ro(n,e),fields:t.value.mapValue.fields}}function dy(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:L(39313,{state:d})}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],o=function(d,m){return d.useProto3Json?(W(m===void 0||typeof m=="string",58123),ye.fromBase64String(m||"")):(W(m===void 0||m instanceof Buffer||m instanceof Uint8Array,16193),ye.fromUint8Array(m||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,l=a&&function(d){const m=d.code===void 0?S.UNKNOWN:wh(d.code);return new V(m,d.message||"")}(a);t=new Rh(r,s,o,l||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=Mi(n,r.document.name),o=We(r.document.updateTime),a=r.document.createTime?We(r.document.createTime):U.min(),l=new Ce({mapValue:{fields:r.document.fields}}),h=Ie.newFoundDocument(s,o,a,l),d=r.targetIds||[],m=r.removedTargetIds||[];t=new us(d,m,h.key,h)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=Mi(n,r.document),o=r.readTime?We(r.readTime):U.min(),a=Ie.newNoDocument(s,o),l=r.removedTargetIds||[];t=new us([],l,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=Mi(n,r.document),o=r.removedTargetIds||[];t=new us([],o,s,null)}else{if(!("filter"in e))return L(11601,{Rt:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:o}=r,a=new ty(s,o),l=r.targetId;t=new Ah(l,a)}}return t}function fy(n,e){let t;if(e instanceof Pr)t={update:vl(n,e.key,e.value)};else if(e instanceof Ih)t={delete:ro(n,e.key)};else if(e instanceof Mt)t={update:vl(n,e.key,e.data),updateMask:Iy(e.fieldMask)};else{if(!(e instanceof J_))return L(16599,{Vt:e.type});t={verify:ro(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(o,a){const l=a.transform;if(l instanceof Er)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(l instanceof An)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:l.elements}};if(l instanceof Rn)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:l.elements}};if(l instanceof vr)return{fieldPath:a.field.canonicalString(),increment:l.Ae};throw L(20930,{transform:a.transform})}(0,r))),e.precondition.isNone||(t.currentDocument=function(s,o){return o.updateTime!==void 0?{updateTime:uy(s,o.updateTime)}:o.exists!==void 0?{exists:o.exists}:L(27497)}(n,e.precondition)),t}function my(n,e){return n&&n.length>0?(W(e!==void 0,14353),n.map(t=>function(s,o){let a=s.updateTime?We(s.updateTime):We(o);return a.isEqual(U.min())&&(a=We(o)),new Q_(a,s.transformResults||[])}(t,e))):[]}function py(n,e){return{documents:[Ph(n,e.path)]}}function gy(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Ph(n,s);const o=function(d){if(d.length!==0)return Vh(Fe.create(d,"and"))}(e.filters);o&&(t.structuredQuery.where=o);const a=function(d){if(d.length!==0)return d.map(m=>function(T){return{field:ln(T.field),direction:Ey(T.dir)}}(m))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const l=to(n,e.limit);return l!==null&&(t.structuredQuery.limit=l),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{ft:t,parent:s}}function _y(n){let e=hy(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){W(r===1,65062);const m=t.from[0];m.allDescendants?s=m.collectionId:e=e.child(m.collectionId)}let o=[];t.where&&(o=function(y){const T=kh(y);return T instanceof Fe&&sh(T)?T.getFilters():[T]}(t.where));let a=[];t.orderBy&&(a=function(y){return y.map(T=>function(N){return new yr(un(N.field),function(k){switch(k){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(N.direction))}(T))}(t.orderBy));let l=null;t.limit&&(l=function(y){let T;return T=typeof y=="object"?y.value:y,xs(T)?null:T}(t.limit));let h=null;t.startAt&&(h=function(y){const T=!!y.before,P=y.values||[];return new ws(P,T)}(t.startAt));let d=null;return t.endAt&&(d=function(y){const T=!y.before,P=y.values||[];return new ws(P,T)}(t.endAt)),x_(e,s,a,o,l,"F",h,d)}function yy(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return L(28987,{purpose:s})}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function kh(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=un(t.unaryFilter.field);return se.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=un(t.unaryFilter.field);return se.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const o=un(t.unaryFilter.field);return se.create(o,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=un(t.unaryFilter.field);return se.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return L(61313);default:return L(60726)}}(n):n.fieldFilter!==void 0?function(t){return se.create(un(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return L(58110);default:return L(50506)}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Fe.create(t.compositeFilter.filters.map(r=>kh(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return L(1026)}}(t.compositeFilter.op))}(n):L(30097,{filter:n})}function Ey(n){return oy[n]}function vy(n){return ay[n]}function Ty(n){return cy[n]}function ln(n){return{fieldPath:n.canonicalString()}}function un(n){return pe.fromServerFormat(n.fieldPath)}function Vh(n){return n instanceof se?function(t){if(t.op==="=="){if(al(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NAN"}};if(ol(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(al(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NOT_NAN"}};if(ol(t.value))return{unaryFilter:{field:ln(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:ln(t.field),op:vy(t.op),value:t.value}}}(n):n instanceof Fe?function(t){const r=t.getFilters().map(s=>Vh(s));return r.length===1?r[0]:{compositeFilter:{op:Ty(t.op),filters:r}}}(n):L(54877,{filter:n})}function Iy(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Nh(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wy{constructor(e){this.yt=e}}function Ay(n){const e=_y({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?As(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class My{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(s=>(r=s,this.remoteDocumentCache.getEntry(e,t))).next(s=>(r!==null&&hr(r.mutation,s,Ne.empty(),J.now()),s))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,j()).next(()=>r))}getLocalViewOfDocuments(e,t,r=j()){const s=Ht();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,r).next(o=>{let a=tr();return o.forEach((l,h)=>{a=a.insert(l,h.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Ht();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,j()))}populateOverlays(e,t,r){const s=[];return r.forEach(o=>{t.has(o)||s.push(o)}),this.documentOverlayCache.getOverlays(e,s).next(o=>{o.forEach((a,l)=>{t.set(a,l)})})}computeViews(e,t,r,s){let o=at();const a=ur(),l=function(){return ur()}();return t.forEach((h,d)=>{const m=r.get(d.key);s.has(d.key)&&(m===void 0||m.mutation instanceof Mt)?o=o.insert(d.key,d):m!==void 0?(a.set(d.key,m.mutation.getFieldMask()),hr(m.mutation,d,m.mutation.getFieldMask(),J.now())):a.set(d.key,Ne.empty())}),this.recalculateAndSaveOverlays(e,o).next(h=>(h.forEach((d,m)=>a.set(d,m)),t.forEach((d,m)=>l.set(d,new Dy(m,a.get(d)??null))),l))}recalculateAndSaveOverlays(e,t){const r=ur();let s=new Z((a,l)=>a-l),o=j();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const l of a)l.keys().forEach(h=>{const d=t.get(h);if(d===null)return;let m=r.get(h)||Ne.empty();m=l.applyToLocalView(d,m),r.set(h,m);const y=(s.get(l.batchId)||j()).add(h);s=s.insert(l.batchId,y)})}).next(()=>{const a=[],l=s.getReverseIterator();for(;l.hasNext();){const h=l.getNext(),d=h.key,m=h.value,y=fh();m.forEach(T=>{if(!o.has(T)){const P=vh(t.get(T),r.get(T));P!==null&&y.set(T,P),o=o.add(T)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,y))}return b.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,s){return function(a){return O.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):ch(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next(o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-o.size):b.resolve(Ht());let l=mr,h=o;return a.next(d=>b.forEach(d,(m,y)=>(l<y.largestBatchId&&(l=y.largestBatchId),o.get(m)?b.resolve():this.remoteDocumentCache.getEntry(e,m).next(T=>{h=h.insert(m,T)}))).next(()=>this.populateOverlays(e,d,o)).next(()=>this.computeViews(e,h,d,j())).next(m=>({batchId:l,changes:dh(m)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new O(t)).next(r=>{let s=tr();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s})}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const o=t.collectionGroup;let a=tr();return this.indexManager.getCollectionParents(e,o).next(l=>b.forEach(l,h=>{const d=function(y,T){return new On(T,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(t,h.child(o));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next(m=>{m.forEach((y,T)=>{a=a.insert(y,T)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,o,s))).next(a=>{o.forEach((h,d)=>{const m=d.getKey();a.get(m)===null&&(a=a.insert(m,Ie.newInvalidDocument(m)))});let l=tr();return a.forEach((h,d)=>{const m=o.get(h);m!==void 0&&hr(m.mutation,d,Ne.empty(),J.now()),Bs(t,d)&&(l=l.insert(h,d))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oi="RestConnection",nE={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class rE{get $o(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Uo=t+"://"+e.host,this.Ko=`projects/${r}/databases/${s}`,this.Wo=this.databaseId.database===Ts?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Go(e,t,r,s,o){const a=oo(),l=this.zo(e,t.toUriEncodedString());D(Oi,`Sending RPC '${e}' ${a}:`,l,r);const h={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(h,s,o);const{host:d}=new URL(l),m=Cn(d);return this.Jo(e,l,h,r,m).then(y=>(D(Oi,`Received RPC '${e}' ${a}: `,y),y),y=>{throw vn(Oi,`RPC '${e}' ${a} failed with error: `,y,"url: ",l,"request:",r),y})}Ho(e,t,r,s,o,a){return this.Go(e,t,r,s,o)}jo(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Nn}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((s,o)=>e[o]=s),r&&r.headers.forEach((s,o)=>e[o]=s)}zo(e,t){const r=nE[e];return`${this.Uo}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gs(n){return new ly(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jt="RemoteStore";class hE{constructor(e,t,r,s,o){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.da=[],this.Aa=o,this.Aa.Oo(a=>{r.enqueueAndForget(async()=>{en(this)&&(D(Jt,"Restarting streams for network reachability change."),await async function(h){const d=F(h);d.Ea.add(4),await kr(d),d.Ra.set("Unknown"),d.Ea.delete(4),await Hs(d)}(this))})}),this.Ra=new uE(r,s)}}async function Hs(n){if(en(n))for(const e of n.da)await e(!0)}async function kr(n){for(const e of n.da)await e(!1)}function Fh(n,e){const t=F(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),Wo(t)?Ho(t):Ln(t).O_()&&Go(t,e))}function zo(n,e){const t=F(n),r=Ln(t);t.Ia.delete(e),r.O_()&&Bh(t,e),t.Ia.size===0&&(r.O_()?r.L_():en(t)&&t.Ra.set("Unknown"))}function Go(n,e){if(n.Va.Ue(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(U.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Ln(n).Y_(e)}function Bh(n,e){n.Va.Ue(e),Ln(n).Z_(e)}function Ho(n){n.Va=new iy({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Ln(n).start(),n.Ra.ua()}function Wo(n){return en(n)&&!Ln(n).x_()&&n.Ia.size>0}function en(n){return F(n).Ea.size===0}function $h(n){n.Va=void 0}async function dE(n){n.Ra.set("Online")}async function fE(n){n.Ia.forEach((e,t)=>{Go(n,e)})}async function mE(n,e){$h(n),Wo(n)?(n.Ra.ha(e),Ho(n)):n.Ra.set("Unknown")}async function pE(n,e,t){if(n.Ra.set("Online"),e instanceof Rh&&e.state===2&&e.cause)try{await async function(s,o){const a=o.cause;for(const l of o.targetIds)s.Ia.has(l)&&(await s.remoteSyncer.rejectListen(l,a),s.Ia.delete(l),s.Va.removeTarget(l))}(n,e)}catch(r){D(Jt,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await bs(n,r)}else if(e instanceof us?n.Va.Ze(e):e instanceof Ah?n.Va.st(e):n.Va.tt(e),!t.isEqual(U.min()))try{const r=await Lh(n.localStore);t.compareTo(r)>=0&&await function(o,a){const l=o.Va.Tt(a);return l.targetChanges.forEach((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const m=o.Ia.get(d);m&&o.Ia.set(d,m.withResumeToken(h.resumeToken,a))}}),l.targetMismatches.forEach((h,d)=>{const m=o.Ia.get(h);if(!m)return;o.Ia.set(h,m.withResumeToken(ye.EMPTY_BYTE_STRING,m.snapshotVersion)),Bh(o,h);const y=new Et(m.target,h,d,m.sequenceNumber);Go(o,y)}),o.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(r){D(Jt,"Failed to raise snapshot:",r),await bs(n,r)}}async function bs(n,e,t){if(!Mn(e))throw e;n.Ea.add(1),await kr(n),n.Ra.set("Offline"),t||(t=()=>Lh(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{D(Jt,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Hs(n)})}function qh(n,e){return e().catch(t=>bs(n,t,e))}async function Ws(n){const e=F(n),t=kt(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:ko;for(;gE(e);)try{const s=await Yy(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,_E(e,s)}catch(s){await bs(e,s)}jh(e)&&zh(e)}function gE(n){return en(n)&&n.Ta.length<10}function _E(n,e){n.Ta.push(e);const t=kt(n);t.O_()&&t.X_&&t.ea(e.mutations)}function jh(n){return en(n)&&!kt(n).x_()&&n.Ta.length>0}function zh(n){kt(n).start()}async function yE(n){kt(n).ra()}async function EE(n){const e=kt(n);for(const t of n.Ta)e.ea(t.mutations)}async function vE(n,e,t){const r=n.Ta.shift(),s=xo.from(r,e,t);await qh(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Ws(n)}async function TE(n,e){e&&kt(n).X_&&await async function(r,s){if(function(a){return ny(a)&&a!==S.ABORTED}(s.code)){const o=r.Ta.shift();kt(r).B_(),await qh(r,()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s)),await Ws(r)}}(n,e),jh(n)&&zh(n)}async function Cl(n,e){const t=F(n);t.asyncQueue.verifyOperationInProgress(),D(Jt,"RemoteStore received new credentials");const r=en(t);t.Ea.add(3),await kr(t),r&&t.Ra.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Hs(t)}async function IE(n,e){const t=F(n);e?(t.Ea.delete(2),await Hs(t)):e||(t.Ea.add(2),await kr(t),t.Ra.set("Unknown"))}function Ln(n){return n.ma||(n.ma=function(t,r,s){const o=F(t);return o.sa(),new oE(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:dE.bind(null,n),t_:fE.bind(null,n),r_:mE.bind(null,n),H_:pE.bind(null,n)}),n.da.push(async e=>{e?(n.ma.B_(),Wo(n)?Ho(n):n.Ra.set("Unknown")):(await n.ma.stop(),$h(n))})),n.ma}function kt(n){return n.fa||(n.fa=function(t,r,s){const o=F(t);return o.sa(),new aE(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)}(n.datastore,n.asyncQueue,{Xo:()=>Promise.resolve(),t_:yE.bind(null,n),r_:TE.bind(null,n),ta:EE.bind(null,n),na:vE.bind(null,n)}),n.da.push(async e=>{e?(n.fa.B_(),await Ws(n)):(await n.fa.stop(),n.Ta.length>0&&(D(Jt,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))})),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ke{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new V(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new V(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return q(this._lat,e._lat)||q(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Ke._jsonSchemaVersion}}static fromJSON(e){if(br(e,Ke._jsonSchema))return new Ke(e.latitude,e.longitude)}}Ke._jsonSchemaVersion="firestore/geoPoint/1.0",Ke._jsonSchema={type:oe("string",Ke._jsonSchemaVersion),latitude:oe("number"),longitude:oe("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe{constructor(e){this._values=(e||[]).map(t=>t)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0}(this._values,e._values)}toJSON(){return{type:Qe._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(br(e,Qe._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(t=>typeof t=="number"))return new Qe(e.vectorValues);throw new V(S.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Qe._jsonSchemaVersion="firestore/vectorValue/1.0",Qe._jsonSchema={type:oe("string",Qe._jsonSchemaVersion),vectorValues:oe("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ZE=/^__.*__$/;class ev{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Mt(e,this.data,this.fieldMask,t,this.fieldTransforms):new Pr(e,this.data,t,this.fieldTransforms)}}class cd{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Mt(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function ld(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw L(40011,{Ac:n})}}class Xs{constructor(e,t,r,s,o,a){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=s,o===void 0&&this.Rc(),this.fieldTransforms=o||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ac(){return this.settings.Ac}Vc(e){return new Xs({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}mc(e){var s;const t=(s=this.path)==null?void 0:s.child(e),r=this.Vc({path:t,fc:!1});return r.gc(e),r}yc(e){var s;const t=(s=this.path)==null?void 0:s.child(e),r=this.Vc({path:t,fc:!1});return r.Rc(),r}wc(e){return this.Vc({path:void 0,fc:!0})}Sc(e){return Cs(e,this.settings.methodName,this.settings.bc||!1,this.path,this.settings.Dc)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}Rc(){if(this.path)for(let e=0;e<this.path.length;e++)this.gc(this.path.get(e))}gc(e){if(e.length===0)throw this.Sc("Document fields must not be empty");if(ld(this.Ac)&&ZE.test(e))throw this.Sc('Document fields cannot begin and end with "__"')}}class tv{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Gs(e)}Cc(e,t,r,s=!1){return new Xs({Ac:e,methodName:t,Dc:r,path:pe.emptyPath(),fc:!1,bc:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ea(n){const e=n._freezeSettings(),t=Gs(n._databaseId);return new tv(n._databaseId,!!e.ignoreUndefinedProperties,t)}function nv(n,e,t,r,s,o={}){const a=n.Cc(o.merge||o.mergeFields?2:0,e,t,s);ia("Data must be an object, but it was:",a,r);const l=hd(r,a);let h,d;if(o.merge)h=new Ne(a.fieldMask),d=a.fieldTransforms;else if(o.mergeFields){const m=[];for(const y of o.mergeFields){const T=uo(e,y,t);if(!a.contains(T))throw new V(S.INVALID_ARGUMENT,`Field '${T}' is specified in your field mask but missing from your input data.`);fd(m,T)||m.push(T)}h=new Ne(m),d=a.fieldTransforms.filter(y=>h.covers(y.field))}else h=null,d=a.fieldTransforms;return new ev(new Ce(l),h,d)}class Ys extends tn{_toFieldTransform(e){if(e.Ac!==2)throw e.Ac===1?e.Sc(`${this._methodName}() can only appear at the top level of your update data`):e.Sc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Ys}}function ud(n,e,t){return new Xs({Ac:3,Dc:e.settings.Dc,methodName:n._methodName,fc:t},e.databaseId,e.serializer,e.ignoreUndefinedProperties)}class ta extends tn{_toFieldTransform(e){return new qs(e.path,new Er)}isEqual(e){return e instanceof ta}}class na extends tn{constructor(e,t){super(e),this.vc=t}_toFieldTransform(e){const t=ud(this,e,!0),r=this.vc.map(o=>nn(o,t)),s=new An(r);return new qs(e.path,s)}isEqual(e){return e instanceof na&&nt(this.vc,e.vc)}}class ra extends tn{constructor(e,t){super(e),this.vc=t}_toFieldTransform(e){const t=ud(this,e,!0),r=this.vc.map(o=>nn(o,t)),s=new Rn(r);return new qs(e.path,s)}isEqual(e){return e instanceof ra&&nt(this.vc,e.vc)}}class sa extends tn{constructor(e,t){super(e),this.Fc=t}_toFieldTransform(e){const t=new vr(e.serializer,ph(e.serializer,this.Fc));return new qs(e.path,t)}isEqual(e){return e instanceof sa&&this.Fc===e.Fc}}function rv(n,e,t,r){const s=n.Cc(1,e,t);ia("Data must be an object, but it was:",s,r);const o=[],a=Ce.empty();Dt(r,(h,d)=>{const m=oa(e,h,t);d=_e(d);const y=s.yc(m);if(d instanceof Ys)o.push(m);else{const T=nn(d,y);T!=null&&(o.push(m),a.set(m,T))}});const l=new Ne(o);return new cd(a,l,s.fieldTransforms)}function sv(n,e,t,r,s,o){const a=n.Cc(1,e,t),l=[uo(e,r,t)],h=[s];if(o.length%2!=0)throw new V(S.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let T=0;T<o.length;T+=2)l.push(uo(e,o[T])),h.push(o[T+1]);const d=[],m=Ce.empty();for(let T=l.length-1;T>=0;--T)if(!fd(d,l[T])){const P=l[T];let N=h[T];N=_e(N);const M=a.yc(P);if(N instanceof Ys)d.push(P);else{const k=nn(N,M);k!=null&&(d.push(P),m.set(P,k))}}const y=new Ne(d);return new cd(m,y,a.fieldTransforms)}function iv(n,e,t,r=!1){return nn(t,n.Cc(r?4:3,e))}function nn(n,e){if(dd(n=_e(n)))return ia("Unsupported field value:",e,n),hd(n,e);if(n instanceof tn)return function(r,s){if(!ld(s.Ac))throw s.Sc(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.Sc(`${r._methodName}() is not currently supported inside arrays`);const o=r._toFieldTransform(s);o&&s.fieldTransforms.push(o)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.fc&&e.Ac!==4)throw e.Sc("Nested arrays are not supported");return function(r,s){const o=[];let a=0;for(const l of r){let h=nn(l,s.wc(a));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),a++}return{arrayValue:{values:o}}}(n,e)}return function(r,s){if((r=_e(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return ph(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const o=J.fromDate(r);return{timestampValue:Rs(s.serializer,o)}}if(r instanceof J){const o=new J(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Rs(s.serializer,o)}}if(r instanceof Ke)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof Me)return{bytesValue:Sh(s.serializer,r._byteString)};if(r instanceof ne){const o=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(o))throw s.Sc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:Fo(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof Qe)return function(a,l){return{mapValue:{fields:{[Zu]:{stringValue:eh},[Is]:{arrayValue:{values:a.toArray().map(d=>{if(typeof d!="number")throw l.Sc("VectorValues must only contain numeric values.");return Lo(l.serializer,d)})}}}}}}(r,s);throw s.Sc(`Unsupported field value: ${Os(r)}`)}(n,e)}function hd(n,e){const t={};return Wu(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Dt(n,(r,s)=>{const o=nn(s,e.mc(r));o!=null&&(t[r]=o)}),{mapValue:{fields:t}}}function dd(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof J||n instanceof Ke||n instanceof Me||n instanceof ne||n instanceof tn||n instanceof Qe)}function ia(n,e,t){if(!dd(t)||!Gu(t)){const r=Os(t);throw r==="an object"?e.Sc(n+" a custom object"):e.Sc(n+" "+r)}}function uo(n,e,t){if((e=_e(e))instanceof Qs)return e._internalPath;if(typeof e=="string")return oa(n,e);throw Cs("Field path arguments must be of type string or ",n,!1,void 0,t)}const ov=new RegExp("[~\\*/\\[\\]]");function oa(n,e,t){if(e.search(ov)>=0)throw Cs(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Qs(...e.split("."))._internalPath}catch{throw Cs(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Cs(n,e,t,r,s){const o=r&&!r.isEmpty(),a=s!==void 0;let l=`Function ${e}() called with invalid data`;t&&(l+=" (via `toFirestore()`)"),l+=". ";let h="";return(o||a)&&(h+=" (found",o&&(h+=` in field ${r}`),a&&(h+=` in document ${s}`),h+=")"),new V(S.INVALID_ARGUMENT,l+n+h)}function fd(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function ei(n){n=ot(n,ne);const e=ot(n.firestore,Nr);return KE(Zo(e),n._key).then(t=>fv(e,n,t))}gn._jsonSchemaVersion="firestore/querySnapshot/1.0",gn._jsonSchema={type:oe("string",gn._jsonSchemaVersion),bundleSource:oe("string","QuerySnapshot"),bundleName:oe("string"),bundle:oe("string")};class Ed extends uv{constructor(e){super(),this.firestore=e}convertBytes(e){return new Me(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ne(this.firestore,null,t)}}function vd(n){n=ot(n,Ot);const e=ot(n.firestore,Nr),t=Zo(e),r=new Ed(e);return cv(n._query),QE(t,n._query).then(s=>new gn(e,r,n,s))}function Td(n,e,t){n=ot(n,ne);const r=ot(n.firestore,Nr),s=hv(n.converter,e);return Id(r,[nv(ea(r),"setDoc",n._key,s,n.converter!==null,t).toMutation(n._key,He.none())])}function Tr(n,e,t,...r){n=ot(n,ne);const s=ot(n.firestore,Nr),o=ea(s);let a;return a=typeof(e=_e(e))=="string"||e instanceof Qs?sv(o,"updateDoc",n._key,e,t,r):rv(o,"updateDoc",n._key,e),Id(s,[a.toMutation(n._key,He.exists(!0))])}function Id(n,e){return function(r,s){const o=new tt;return r.asyncQueue.enqueueAndForget(async()=>LE(await WE(r),s,o)),o.promise}(Zo(n),e)}function fv(n,e,t){const r=t.docs.get(e._key),s=new Ed(n);return new Kt(n,s,e._key,r,new rr(t.hasPendingWrites,t.fromCache),e.converter)}function Rt(){return new ta("serverTimestamp")}function mv(...n){return new na("arrayUnion",n)}function pv(...n){return new ra("arrayRemove",n)}function jt(n){return new sa("increment",n)}(function(e,t=!0){(function(s){Nn=s})(kn),yn(new Qt("firestore",(r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),l=new Nr(new r_(r.getProvider("auth-internal")),new o_(a,r.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new V(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new gr(d.options.projectId,m)}(a,s),a);return o={useFetchStreams:t,...o},l._setSettings(o),l},"PUBLIC").setMultipleInstances(!0)),It(Hc,Wc,e),It(Hc,Wc,"esm2020")})();const gv={apiKey:"AIzaSyDeWt5865wLYJ8S0FZHi_nuVxRDl8PbmOM",authDomain:"lumus-games.firebaseapp.com",projectId:"lumus-games",storageBucket:"lumus-games.firebasestorage.app",messagingSenderId:"410752075154",appId:"1:410752075154:web:6b8225d97ebc24cabded4b",measurementId:"G-6X1D8TK91D"},wd=nu(gv),da=Zg(wd),Nt=YE(wd),_v=new Je;function fa(){const n=new Date,e=new Date(n.getFullYear(),0,1),t=(n-e)/864e5,r=Math.ceil((t+e.getDay()+1)/7);return`${n.getFullYear()}-W${r}`}async function yv(){try{const n=await cg(da,_v);return await Tv(n.user),n.user}catch(n){throw console.error("Google Sign-In Error:",n),n}}async function Ev(){try{await qp(da)}catch(n){throw console.error("Sign Out Error:",n),n}}function vv(n){return $p(da,n)}async function Tv(n){if(!n)return null;const e=Pn(Nt,"users",n.uid),t=await ei(e);return t.exists()?await Tr(e,{lastLoginAt:Rt(),displayName:n.displayName||t.data().displayName,photoURL:n.photoURL||t.data().photoURL}):(await Td(e,{displayName:n.displayName||"Player",email:n.email,photoURL:n.photoURL,createdAt:Rt(),lastLoginAt:Rt(),tokens:0,stats:{totalGamesPlayed:0,totalPlayTimeMinutes:0,favoriteGames:[]}}),console.log("New user profile created!")),Dr(n.uid)}async function Dr(n){if(!n)return null;const e=Pn(Nt,"users",n),t=await ei(e);return t.exists()?{id:t.id,...t.data()}:null}async function Iv(n,e){var a;if(!n||!e)return!1;const t=await Dr(n);if(!t)return!1;const s=(((a=t.stats)==null?void 0:a.favoriteGames)||[]).includes(e),o=Pn(Nt,"users",n);return await Tr(o,{"stats.favoriteGames":s?pv(e):mv(e)}),!s}async function wv(n,e){var s;if(!n||!e)return!1;const t=await Dr(n);return t?(((s=t.stats)==null?void 0:s.favoriteGames)||[]).includes(e):!1}async function Av(n){var t;if(!n)return[];const e=await Dr(n);return e?((t=e.stats)==null?void 0:t.favoriteGames)||[]:[]}async function Ad(n,e,t="reward"){var a,l;if(!n||e<=0)return!1;const r=Math.min(e,50),s=fa(),o=Pn(Nt,"users",n);try{const h=await ei(o);if(!h.exists())return!1;const d=h.data(),m=(a=d.weeklyStats)==null?void 0:a.weekId,y=((l=d.weeklyStats)==null?void 0:l.tokens)||0;let T={tokens:jt(r),lastTokenUpdate:Rt()};return m!==s?T.weeklyStats={weekId:s,tokens:r,lastReset:Rt()}:T["weeklyStats.tokens"]=jt(r),await Tr(o,T),console.log(`Added ${r} tokens (${t}) - Week: ${s}`),!0}catch(h){return console.error("Error adding tokens:",h),!1}}async function Rv(n=20){const e=fa(),t=ad(Nt,"users");console.log("Fetching leaderboard for week:",e);const r=pd(t,lv("weeklyStats.weekId","==",e),gd("weeklyStats.tokens","desc"),_d(n));try{const s=await vd(r),o=[];return s.forEach(a=>{var h;const l=a.data();o.push({userId:a.id,displayName:l.displayName,photoURL:l.photoURL,weeklyTokens:((h=l.weeklyStats)==null?void 0:h.tokens)||0})}),console.log("Leaderboard query returned:",o.length,"results"),o}catch(s){return console.error("Error fetching leaderboard:",s),console.error("Error details:",s.code,s.message),[]}}async function Rd(n,e,t={}){if(!n||!e)return!1;const r=Pn(Nt,"users",n,"gameProgress",e),s=await ei(r),o=t.tokensEarned||0,a=t.playTimeSeconds||0;if(!s.exists())await Td(r,{playCount:1,firstPlayed:Rt(),lastPlayed:Rt(),highScore:t.score||0,totalTokensEarned:o,totalPlayTimeSeconds:a});else{const h=s.data();await Tr(r,{playCount:jt(1),lastPlayed:Rt(),highScore:Math.max(h.highScore||0,t.score||0),totalTokensEarned:jt(o),totalPlayTimeSeconds:jt(a)})}const l=Pn(Nt,"users",n);return await Tr(l,{"stats.totalGamesPlayed":jt(1),"stats.totalPlayTimeSeconds":jt(a)}),!0}async function Sv(n,e=5){if(!n)return[];const t=ad(Nt,"users",n,"gameProgress"),r=pd(t,gd("lastPlayed","desc"),_d(e)),s=await vd(r),o=[];return s.forEach(a=>{o.push({gameId:a.id,...a.data()})}),o}let Sd=[];function bd(n){Sd=n}function bv(n){var e;return n?`
  ...
  `:""}async function Pv(n){if(n)try{const e=await Dr(n);if(!e)return;const t=document.getElementById("account-tokens");t&&kv(t,e.tokens||0);const r=e.stats||{},s=document.getElementById("stat-games"),o=document.getElementById("stat-time"),a=document.getElementById("stat-favs");s&&(s.textContent=r.totalGamesPlayed||0),o&&(o.textContent=Vv(r.totalPlayTimeSeconds||0)),a&&(a.textContent=(r.favoriteGames||[]).length);const l=await Sv(n,5);Cv(l)}catch(e){console.error("Error loading account data:",e)}}function Cv(n){const e=document.getElementById("recent-games-container");if(e){if(!n||n.length===0){e.innerHTML=`
    ...
    `}).join("")}}function kv(n,e){const s=performance.now();function o(a){const l=a-s,h=Math.min(l/1e3,1),d=1-Math.pow(1-h,3),m=Math.floor(0+(e-0)*d);n.textContent=m.toLocaleString(),h<1&&requestAnimationFrame(o)}requestAnimationFrame(o)}function Vv(n){if(n<60)return`${n}s`;const e=Math.floor(n/60);if(e<60)return`${e}m`;const t=Math.floor(e/60),r=e%60;return t<24?`${t}h ${r}m`:`${Math.floor(t/24)}d`}function Nv(){const n=document.getElementById("account-page");n&&(n.classList.add("active"),document.body.style.overflow="hidden")}function Ui(){const n=document.getElementById("account-page");n&&(n.classList.remove("active"),document.body.style.overflow="")}function Dv(n){const e=document.getElementById("account-back-btn"),t=document.getElementById("earn-more-btn"),r=document.getElementById("recent-games-container");e&&e.addEventListener("click",Ui),t&&t.addEventListener("click",()=>{Ui()}),r&&r.addEventListener("click",s=>{const o=s.target.closest(".recent-game-card");if(o&&n){const a=o.dataset.gameId;Ui(),n(a)}})}let hn=null;function Mv(n){hn=n}function Ov(){return`
    ...
    `}async function Lv(){var t;const n=document.getElementById("leaderboard-list"),e=document.getElementById("lb-week-display");if(n){e.textContent=fa();try{const r=await Rv(50);if(console.log("Leaderboard fetched:",r.length,"players"),console.log("Current user:",hn?hn.uid:"Not signed in"),r.length===0){const o=hn?"No champions yet this week.<br>Be the first!":"No champions yet this week.<br>Sign in to compete!";n.innerHTML=`<div class="lb-empty">${o}</div>`;return}let s="";r.forEach((o,a)=>{var m;const l=a+1,h=hn&&o.userId===hn.uid,d=o.photoURL||`https://placehold.co/100x100/333/fff?text=${((m=o.displayName)==null?void 0:m.charAt(0))||"P"}`;s+=`
...
`;let ie=0,sr=null,De=null,je=null;const Fv=document.getElementById("track");let _n=document.querySelectorAll(".game-card");const Bv=document.getElementById("hero-bg"),$v=document.getElementById("d-title"),qv=document.getElementById("d-desc"),jv=document.getElementById("d-tags"),Pd=document.getElementById("play-btn");function zv(){return window.innerWidth>=1024?{cardWidth:150,gap:20,activeGrowth:0}:{cardWidth:140,gap:20,activeGrowth:20}}function Ue(n){_n.forEach(s=>s.classList.remove("active")),_n[n]&&_n[n].classList.add("active");const e=zv(),t=n*(e.cardWidth+e.gap);Fv.style.transform=`translateX(-${t}px)`;const r=ge[n];$v.innerText=r.title,qv.innerText=r.desc,jv.innerHTML=r.tags.map(s=>`<span class="tag-badge">${s}</span>`).join(""),Pd.textContent=r.locked?"SOON":"PLAY NOW",Bv.innerHTML=`<img src="${r.hero}" class="hero-image" style="animation: fadeIn 0.4s">`}let Cd=0,ho=!1;const kd=document.getElementById("carousel-container");kd.addEventListener("touchstart",n=>{Cd=n.touches[0].clientX,ho=!0},{passive:!0});kd.addEventListener("touchend",n=>{if(!ho)return;const e=Cd-n.changedTouches[0].clientX;Math.abs(e)>30&&(e>0&&ie<ge.length-1?ie++:e<0&&ie>0&&ie--,Ue(ie)),ho=!1});const fo=document.getElementById("game-container"),Vd=document.getElementById("close-btn");let ir=null;function Mr(){const n=ge[ie];if(n.locked||!n.path)return;Md(n.id),console.log("🚀 launchGame called, tracking started for:",n.id);const e=`${window.location.pathname}?id=${n.id}`;window.history.pushState({gameId:n.id},n.title,e);const t=`${Uv}${n.path}`,r=document.createElement("iframe");r.src=t,r.sandbox="allow-scripts allow-same-origin allow-popups allow-forms allow-pointer-lock",r.allow="autoplay; fullscreen",fo.appendChild(r),fo.style.display="block",ir=r,r.onload=()=>r.contentWindow.focus()}_n.forEach((n,e)=>{n.addEventListener("click",()=>{ie=e,Ue(ie),window.innerWidth>=1024&&Mr()})});Pd.addEventListener("click",Mr);Vd.addEventListener("click",()=>{ir&&(ir.src="about:blank",ir.remove(),ir=null),fo.style.display="none",window.history.pushState({},document.title,window.location.pathname)});function Gv(){const e=new URLSearchParams(window.location.search).get("id");if(e){const t=ge.findIndex(r=>r.id.toLowerCase()===e.toLowerCase());t!==-1?(ie=t,Ue(ie),ge[ie].locked||Mr()):Ue(0)}else Ue(0)}Gv();window.addEventListener("resize",()=>Ue(ie));const ks=document.getElementById("auth-modal"),Hv=document.getElementById("auth-modal-close"),Zn=document.getElementById("google-sign-in-btn"),zt=document.getElementById("user-avatar"),Fi=document.getElementById("user-avatar-img"),ma=document.getElementById("user-menu"),Wv=document.getElementById("user-menu-avatar"),Kv=document.getElementById("user-menu-name"),Qv=document.getElementById("user-menu-email"),Xv=document.getElementById("sign-out-btn");let fe=null;function Nd(){ks.style.display="flex",document.body.style.overflow="hidden"}function pa(){ks.style.display="none",document.body.style.overflow=""}const Gl=document.getElementById("leaderboard-btn");Gl&&Gl.addEventListener("click",()=>{xv()});function Yv(){ma.classList.add("active")}function ti(){ma.classList.remove("active")}function Jv(n){var t,r;const e=document.getElementById("user-avatar-svg");zt.classList.remove("loading"),n?(fe=n,Fi.src=n.photoURL||"https://placehold.co/100x100/000/fff?text="+(((t=n.displayName)==null?void 0:t.charAt(0))||"U"),Fi.style.display="block",e&&(e.style.display="none"),Wv.src=n.photoURL||"https://placehold.co/100x100/000/fff?text="+(((r=n.displayName)==null?void 0:r.charAt(0))||"U"),Kv.textContent=n.displayName||"User",Qv.textContent=n.email||"",zt.classList.add("signed-in"),zt.classList.remove("not-signed-in")):(fe=null,Fi.style.display="none",e&&(e.style.display="block"),zt.classList.remove("signed-in"),zt.classList.add("not-signed-in"),ti())}zt.addEventListener("click",()=>{fe?Yv():Nd()});Hv.addEventListener("click",pa);ks.addEventListener("click",n=>{n.target===ks&&pa()});const Zv=`
  <svg width="18" height="18" viewBox="0 0 18 18" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844c-.209 1.125-.843 2.078-1.796 2.717v2.258h2.908c1.702-1.567 2.684-3.874 2.684-6.615z" fill="#4285F4"/>
    <path d="M9.003 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.258c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.96v2.332C2.44 15.983 5.485 18 9.003 18z" fill="#34A853"/>
    <path d="M3.964 10.712c-.18-.54-.282-1.117-.282-1.71 0-.593.102-1.17.282-1.71V4.96H.957C.347 6.175 0 7.55 0 9.002c0 1.452.348 2.827.957 4.042l3.007-2.332z" fill="#FBBC05"/>
